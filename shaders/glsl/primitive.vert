...
void main() 
{
    ...
    // int iVertexStride = 0;
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_POSITION));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_NORMAL));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_TANGENT));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_TEXCOORD_0));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_TEXCOORD_1));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_COLOR_0));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_COLOR_1));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_JOINTS_0));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_JOINTS_1));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_WEIGHTS_0));
    // iVertexStride += int(bool(MeshVariantFlags & PL_MESH_FORMAT_FLAG_HAS_WEIGHTS_1));
