    ...
    )
{
    ...
    float4 tBaseColor = bg1.tAlbedoTexture.sample(bg1.tAlbedoSampler, in.tUV);
    float3 tNormal = bg1.tNormalTexture.sample(bg1.tNormalSampler, in.tUV).xyz;
    float fDepth = bg1.tDepthTexture.sample(bg1.tDepthSampler, in.tUV).r;
